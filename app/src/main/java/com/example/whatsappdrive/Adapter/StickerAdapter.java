...
public class StickerAdapter extends RecyclerView.Adapter<StickerAdapter.ViewModel> {

    Stickerfragment context;
    ArrayList<ModelClass> arrayList;

    public StickerAdapter(Stickerfragment context, ArrayList<ModelClass> arrayList) {
    ...
    public ViewModel onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new StickerAdapter.ViewModel(view);
    }
