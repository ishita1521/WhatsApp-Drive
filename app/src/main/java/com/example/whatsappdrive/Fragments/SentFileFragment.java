...
import com.example.whatsappdrive.Adapter.SentFileAdapter;
...
public class SentFileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        destpath=bundle.getString("DEST_LOCATION");
    ...
    private void setupLayout() {
        ...
        adapter= new SentFileAdapter(this,getdata());
    ...
    private ArrayList<ModelClass> getdata() {
        ...
        String targetPath = Environment.getExternalStorageDirectory().getAbsolutePath() +destpath ;
